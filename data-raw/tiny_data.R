...
PBMC <- list(
    RNA_count_tiny = RNA_count_tiny,
    RNA_zscore_tiny = RNA_zscore_tiny,
    clusters_tiny = clusters_tiny
)
save(PBMC, file = file.path("data", "PBMC.RData"))

save(rl_map_tiny, file = file.path("data", "RL_Map.RData"))
save(regulon_list_tiny, file = file.path("data", "Regulon_List.RData"))
save(pbmc_dom_tiny_list, file = file.path("data", "Domino_List.RData"))
save(pbmc_dom_built_tiny_list, file = file.path("data", "Built_Domino_List.RData"))
