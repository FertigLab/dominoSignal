test_that("rename_clusters function works correctly", {
    ...
    expect_named(dom_renamed@linkages$clust_rec, c("X", "Y")) # only CD8 T Cell and CD14 monocyte present
    expect_named(dom_renamed@linkages$clust_incoming_lig, c("X", "Y")) # only CD14 monocyte and CD8 T Cell present
