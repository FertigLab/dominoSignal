...
- [`print(`*`<domino>`*`)`](https://FertigLab.github.io/dominoSignal/reference/print-domino-method.md)
  : Print domino object
- [`print(`*`<linkage_summary>`*`)`](https://FertigLab.github.io/dominoSignal/reference/print-linkage_summary-method.md)
...
- [`show(`*`<linkage_summary>`*`)`](https://FertigLab.github.io/dominoSignal/reference/show-linkage_summary-method.md)
