...
#>  [22] dbplyr_2.5.2          XVector_0.50.0        rmarkdown_2.31       
...
#>  [43] Rcpp_1.1.1            Seqinfo_1.0.0         iterators_1.0.14     
#>  [46] knitr_1.51            IRanges_2.44.0        Matrix_1.7-4         
#>  [49] igraph_2.2.3          tidyselect_1.2.1      abind_1.4-8          
#>  [52] yaml_2.3.12           doParallel_1.0.17     codetools_0.2-20     
#>  [55] curl_7.0.0            lattice_0.22-9        tibble_3.3.1         
#>  [58] plyr_1.8.9            Biobase_2.70.0        withr_3.0.2          
#>  [61] KEGGREST_1.50.0       S7_0.2.1              evaluate_1.0.5       
#>  [64] desc_1.4.3            BiocFileCache_3.0.0   circlize_0.4.18      
#>  [67] Biostrings_2.78.0     pillar_1.11.1         ggpubr_0.6.3         
#>  [70] filelock_1.0.3        carData_3.0-6         foreach_1.5.2        
#>  [73] stats4_4.5.3          generics_0.1.4        S4Vectors_0.49.1-1   
#>  [76] hms_1.1.4             ggplot2_4.0.2         scales_1.4.0         
#>  [79] glue_1.8.0            tools_4.5.3           ggsignif_0.6.4       
#>  [82] fs_2.0.1              grid_4.5.3            tidyr_1.3.2          
...
#> [106] GlobalOptions_0.1.4   bit64_4.6.0-1
```
