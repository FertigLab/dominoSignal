...
1.  Transcription factor activation scores are calculated (we recommend
    ...
    Activation](https://fertiglab.github.io/dominoSignal/articles/tf_scenic_vignette.html)
    page.
...
functions](https://fertiglab.github.io/dominoSignal/articles/plotting_vignette.html)
and the structure of the [domino
object](https://fertiglab.github.io/dominoSignal/articles/domino_object_vignette.html).
