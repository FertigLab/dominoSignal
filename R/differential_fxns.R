...
#' )
#'
#' #identify intercellular linkages
#' pbmc_dom_tiny <- add_intercellular_linkages(
#'   dom = pbmc_dom_tiny, signal_threshold = 0
#' )
#' pbmc_dom_tiny_alt <- add_intercellular_linkages(
#'   dom = pbmc_dom_tiny_alt, signal_threshold = 0
#' )
#'
